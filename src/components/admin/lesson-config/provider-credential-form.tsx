        ...
        return (
          <div key={field.name} className="flex flex-col gap-1.5">
            ...
            <input
              ...
              className={cn(
                'min-w-0 w-full rounded-lg border bg-gray-1 px-3.5 py-2.5 font-mono text-gray-12 text-sm outline-none transition-colors duration-100 placeholder:text-gray-8',
                'focus-visible:border-apple-9 focus-visible:ring-2 focus-visible:ring-apple-9',
                field.error
                  ? 'border-red-9 focus-visible:border-red-9 focus-visible:ring-red-9'
