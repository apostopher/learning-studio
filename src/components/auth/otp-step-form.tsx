  ...
  return (
    <form onSubmit={onSubmit} noValidate>
      <p className="mb-6 text-sm text-gray-11">
        ...
        <span className="font-medium text-gray-12">{maskedEmail}</span>
      </p>
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <p id={hintId} className="text-xs text-gray-11">
      ...
      <div className="mt-5 flex items-center justify-between text-sm">
        <button
          ...
          onClick={onBack}
          disabled={isLoading}
          className="flex items-center gap-1.5 text-gray-11 hover:text-gray-12 focus-visible:outline-none focus-visible:underline transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
        >
